...
import AsIf from '../../../../images/As.jpeg'
...
import audioDu from '../../../audio/dududu.mp3'
import audioHow from '../../../audio/how.mp3'
import audioTypa from '../../../audio/typa.mp3'
import audioFire from '../../../audio/playing.mp3'
import audioReally from '../../../audio/really.mp3'
import audioLove from '../../../audio/Lovesick.mp3'

import audioSee from '../../../audio/see.mp3'
...
export const songs = [
  {
    ...
    geu nunbichi ajig naleul
    ileohge seollege hae Boom boom
     
    24, 365
    ojig neowa gati hagopa
    najedo i bamedo
    ileohge neoleul wonhae Ooh ooh
    ...
    aju ssigssighage ttaelon Chic chic hage
    So hot, so hot naega
    eojjeol jul moleuge hae
    najimagi bulleojwo
    nae gwisgae doneun hwipalamcheoleom
     
    idaelo jinachiji mayo
    neodo nacheoleom nal
    ijeul suga eobsdamyeon Whoa
    neol hyanghan i maeumeun Fire
    nae simjangi ppaleuge ttwijanha
    jeomjeom gakkai deullijanha
     
    hwipalam
    Uh hwi palam palam palam
    (Can you hear that)
    ...
    balamcheoleom seuchyeoganeun
    heunhan inyeoni anigil
    manheun maleun pilyo eobseo
    jigeum neoui gyeote
    naleul delyeoga jwo Ooh
  ...
  },
  {
    ...
    Like du-du-dun, du-lu-lu-lun
    Like du-du-dun, du-lu-lu-lun`,
    lyrics2: 'Only english version is available',
  },
  {
    songId: 6,
...
`,
  ...
  },
  {
    ...
    Let's go, let's go
    `,
    lyrics2: `BLACKPINK in your area
    BLACKPINK in your area
